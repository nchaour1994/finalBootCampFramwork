...
public class ConnectDB {
    ...
    public Properties loadProperties() throws IOException {
        ...
        InputStream ism = new FileInputStream("..\\Generic\\src\\main\\java\\resources\\secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
    ...
    public List<String> readFromMongo(){
        ...
        MongoDatabase db = mongoClient.getDatabase("items");
        System.out.println("Database Connected");
        MongoCollection collection = db.getCollection("Myitems");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(con.readFromMongo());
    }
}